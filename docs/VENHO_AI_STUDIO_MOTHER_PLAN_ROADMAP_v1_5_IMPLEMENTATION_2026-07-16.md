...
> Bảng này là snapshot chụp giữa lúc triển khai roadmap v1.5, **trước** khi Phase 0–6 và closeout QA-01/DOC-01 hoàn tất trong cùng ngày. Con số hiện hành, chính thức là bảng ở §0 (443/443 và 65/65, khớp `task_status.md`). Giữ bảng dưới đây làm lịch sử tiến trình, không dùng làm acceptance baseline.
...
Baseline 423 tests và M03 26 tests trong v1.4 đã lỗi thời do thêm regression test cho face-score normalization. Baseline 424/54 ở trên, đến lượt nó, cũng đã lỗi thời ngay trong ngày 2026-07-16 — xem §0 để lấy con số current thật (443/65).
...
| Thay đổi | v1.4 | v1.5 |
|---|---|---|
| AI Studio baseline | 423 tests | 424 tests (snapshot giữa kỳ) → **443** sau closeout §0 |
