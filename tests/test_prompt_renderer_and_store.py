...
def test_save_prompt_writes_md_and_json_with_brief_slug_in_filename(tmp_path):
    ...
    assert paths.markdown.name == "LAKE_VIEW_ROOM_1__booking-style__IMAGE_PROMPT_v1.0.md"
    assert paths.json.name == "LAKE_VIEW_ROOM_1__booking-style__IMAGE_PROMPT_v1.0.json"
